<?php
/**
 * Template Name: Resumes Pricing
 *
 * @package Babysitter
 * @since Babysitter 1.0
 */
			...
			<div class="wc-job-packages wc-job-packages__style1">
				...
				<?php while ( $packages->have_posts() ) : $packages->the_post(); $package = get_product( get_post()->ID ); ?>
					...
					<div class="<?php echo $table_col; ?>">
						<div class="pricing-table woocommerce <?php echo $table_style; ?>">
							...
							<div class="pricing-body">
								...
								<?php
									...
									echo _n(
										sprintf(
											'%1$s %2$s %3$s',
											$limit == 0 ? __( 'Unlimited', 'babysitter' ) : $limit,
							...
							<footer class="pricing-footer">
								<?php
									...
									$label 	= apply_filters( 'add_to_cart_text', __( 'Add to cart', 'babysitter' ) );
								?>
