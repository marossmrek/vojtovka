...
if(isset($babysitter_data['babysitter__form-resumes-field-keywords'])) {
	$field_keywords = $babysitter_data['babysitter__form-resumes-field-keywords'];
} else {
	$field_keywords = __('Keywords', 'babysitter');
}

// Location Search Field - Placeholder Text
if(isset($babysitter_data['babysitter__form-resumes-field-location'])) {
	$field_location = $babysitter_data['babysitter__form-resumes-field-location'];
} else {
	$field_location = __('Any Location', 'babysitter');
}

// Categories Search Field - Placeholder Text
if(isset($babysitter_data['babysitter__form-resumes-field-category'])) {
	$field_category = $babysitter_data['babysitter__form-resumes-field-category'];
} else {
