<div id="job-manager-job-applications">
	<div class="job-manager-job-applications__top">
		<p>
			<a href="<?php echo esc_url( add_query_arg( 'download-csv', true ) ); ?>" class="job-applications-download-csv btn btn-default"><i class="fa fa-download"></i> <?php _e( 'Download CSV', 'babysitter' ); ?></a>
		</p>
		<p><?php printf( __( 'The job applications for "%s" are listed below.', 'babysitter' ), '<a href="' . get_permalink( $job_id ) . '">' . get_the_title( $job_id ) . '</a>' ); ?></p>
	</div>
					...
					<div class="form-group">
						<div class="select-style">
							<select name="application_status">
								<option value=""><?php _e( 'Filter by status', 'babysitter' ); ?>...</option>
					...
					<div class="form-group">
						<div class="select-style">
							<select name="application_orderby">
								<option value=""><?php _e( 'Newest first', 'babysitter' ); ?></option>
								<option value="name" <?php selected( $application_orderby, 'name' ); ?>><?php _e( 'Sort by name', 'babysitter' ); ?></option>
								<option value="rating" <?php selected( $application_orderby, 'rating' ); ?>><?php _e( 'Sort by rating', 'babysitter' ); ?></option>
							</select>
						</div>
					</div>
