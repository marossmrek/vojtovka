...
<?php
	...
	$layout_border_radius = $babysitter_data['babysitter__layout-border-radius'];
	...
	$typography_main_nav = $babysitter_data['typography-nav'];
	if ( $typography_main_nav != '0' ) {
		$theme_options_styles .= '
		@media (min-width: 992px) {
			.flexnav > li > a{
				font-size: ' . $typography_main_nav['font-size'] . ';
				font-family: ' . $typography_main_nav['font-family'] . ';
				font-weight: ' . $typography_main_nav['font-weight'] . ';
			}
		}';
	}

	$typography_top_bar = $babysitter_data['babysitter__typography-top-bar'];
