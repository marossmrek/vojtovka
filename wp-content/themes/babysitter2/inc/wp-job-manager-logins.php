...
if(!function_exists('custom_submit_job_form_login_url')) { 
	function custom_submit_job_form_login_url() {
		...
		if(isset($babysitter_data['babysitter__job-manager-login-page'])) {
			return get_permalink($babysitter_data['babysitter__job-manager-login-page']);
		}
	}
}
...
if(!function_exists('custom_submit_resume_form_login_url')) { 
	function custom_submit_resume_form_login_url() {
		...
		if(isset($babysitter_data['babysitter__resume-manager-login-page'])) {
	  	return get_permalink($babysitter_data['babysitter__resume-manager-login-page']);
		}
	}
}
