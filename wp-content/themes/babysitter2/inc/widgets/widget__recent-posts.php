...
class Posts_Widget extends WP_Widget {
  ...
  function __construct() {
    $widget_ops = array(
      ...
      'description' => __('The most recent posts on your site.', 'babysitter')
    );

    $control_ops = array('id_base' => 'latest-posts');

    parent::__construct('latest-posts', 'Babysitter - Recent Posts', $widget_ops, $control_ops);
  }
  ...
  function form($instance)
  {
    ...
    <p>
      <label for="<?php echo $this->get_field_id('img_size'); ?>"><?php _e('Thumbnail:', 'babysitter'); ?></label> 
