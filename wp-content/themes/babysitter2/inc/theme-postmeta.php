...
$meta_box_post_formats = array(
	'id' => 'babysitter-meta-box-post-formats',
	'title' =>  __('Post Formats Meta', 'babysitter'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array(
			"name" => __('Gallery - Gallery IDs','babysitter'),
			"desc" => __('Enter the gallery IDs you created. Example: 9,21','babysitter'),
		...
		array(
			"name" => __('Quote - Author','babysitter'),
			"desc" => __('Enter quote auhthor name for Quote post format','babysitter'),
		...
		array(
			"name" => __('Quote - Author Info','babysitter'),
			"desc" => __('Enter quote auhthor info (position) for Quote post format','babysitter'),
		...
		array(
			"name" => __('Link - URL','babysitter'),
			"desc" => __('URL for the link','babysitter'),
...
function babysitter_add_box() {
	...
	add_meta_box($meta_box_post_formats['id'], $meta_box_post_formats['title'], 'babysitter_show_box_quote', $meta_box_post_formats['page'], $meta_box_post_formats['context'], $meta_box_post_formats['priority']);
}
