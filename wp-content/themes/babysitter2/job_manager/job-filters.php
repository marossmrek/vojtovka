...
if(isset($babysitter_data['babysitter__form-jobs-field-keywords'])) {
	$field_keywords = $babysitter_data['babysitter__form-jobs-field-keywords'];
} else {
	$field_keywords = __('Keywords', 'babysitter');
}

// Location Search Field - Placeholder Text
if(isset($babysitter_data['babysitter__form-jobs-field-location'])) {
	$field_location = $babysitter_data['babysitter__form-jobs-field-location'];
} else {
	$field_location = __('Any Location', 'babysitter');
}

// Categories Search Field - Placeholder Text
if(isset($babysitter_data['babysitter__form-jobs-field-category'])) {
	$field_category = $babysitter_data['babysitter__form-jobs-field-category'];
} else {
	$field_category = __('Any category', 'babysitter');
}
...
<form class="job_filters">
	...
	<div class="search_jobs <?php echo $search_jobs_class; ?>">
		...
		<div class="search_submit">
			<label for="search_submit"><?php _e( 'Submit', 'babysitter' ); ?></label>
			<button type="submit" class="btn btn-block btn-primary btn-single-icon"><i class="fa fa-lg fa-search"></i></button>
		</div>
...
<noscript><?php _e( 'Your browser does not support JavaScript, or it is disabled. JavaScript must be enabled in order to view listings.', 'babysitter' ); ?></noscript>