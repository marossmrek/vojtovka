...
$link_url          = esc_url(get_post_meta(get_the_ID(), 'babysitter_format_link_url', true));
$quote_author      = get_post_meta(get_the_ID(), 'babysitter_format_quote_author', true);
$quote_pos         = get_post_meta(get_the_ID(), 'babysitter_format_quote_pos', true);
$gallery_ids       = get_post_meta(get_the_ID(), 'babysitter_format_gallery_id', true);
...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
	...
	<?php } else { ?>
		...
		<?php if(has_post_thumbnail() && $babysitter_data['opt-post-image'] == 1 ) { ?>
	...
	<header class="entry-header">
		...
		<?php if($babysitter_data['opt-post-title'] == 1): ?>
...
<?php if($babysitter_data['opt-social-box'] == 1): ?>
	<div class="post-share-box">
		<span class="share-box-title"><?php _e('Social Share:', 'babysitter'); ?></span>
...
<?php if($babysitter_data['opt-info-box']): ?>
